...
set(MSG_I_FLAGS "-Ipozyx_simulation:/projects/src/pozyx_simulation/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/projects/src/pozyx_simulation/msg/uwb_data.msg" NAME_WE)
add_custom_target(_pozyx_simulation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pozyx_simulation" "/projects/src/pozyx_simulation/msg/uwb_data.msg" ""
)
...
_generate_msg_cpp(pozyx_simulation
  "/projects/src/pozyx_simulation/msg/uwb_data.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pozyx_simulation)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pozyx_simulation\")")
  # install generated code
  install(
