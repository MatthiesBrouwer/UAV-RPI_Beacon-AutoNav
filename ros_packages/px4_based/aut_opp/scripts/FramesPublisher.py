...
#
#
# this files is copied from the package mascor_uav_workshop, but t can be used as a lay out for a tf broadcaster in python. The link need to be adjusted and can be found in the URDF files. 
#
#
#
