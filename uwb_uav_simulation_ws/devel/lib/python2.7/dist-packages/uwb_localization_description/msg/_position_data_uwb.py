...
"""autogenerated by genpy from uwb_localization_description/position_data_uwb.msg. Do not edit."""
import sys
...
class position_data_uwb(genpy.Message):
  _md5sum = "cffdb089f0ead7804716b039674b3438"
  _type = "uwb_localization_description/position_data_uwb"
...
"""
  __slots__ = ['destination_id','distance','stamp','uwb_position']
  _slot_types = ['int64[]','float64[]','time[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       destination_id,distance,stamp,uwb_position
    ...
    """
    if args or kwds:
      super(position_data_uwb, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.uwb_position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.uwb_position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.uwb_position = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.uwb_position.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.uwb_position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
