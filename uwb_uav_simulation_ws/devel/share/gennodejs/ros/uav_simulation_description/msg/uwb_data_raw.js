...
// (in-package uav_simulation_description.msg)
...
class uwb_data_raw {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type uwb_data_raw
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type uwb_data_raw
    let len;
    let data = new uwb_data_raw(null);
  ...
  static datatype() {
    ...
    return 'uav_simulation_description/uwb_data_raw';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new uwb_data_raw(null);
